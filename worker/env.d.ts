/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/env.d.ts` (hash: 088c83d6a7442a947780a3e5fb2d63e5)
...
interface __BaseEnv_Env {
	...
	PRESENT_STUDIO: DurableObjectNamespace<import("./index").PresentStudioContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "PresentStudioContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "JWT_SECRET" | "PUBLIC_BASE_URL" | "CLOUDINARY_CLOUD_NAME" | "CLOUDINARY_API_KEY" | "CLOUDINARY_API_SECRET" | "CLOUDINARY_FOLDER">> {}
}
