(() => {
  ...
  const home = [
    ...
    group("Media", `<label class="tool-button tool-tall file-ribbon-tool"><input type="file" accept="image/*" data-media-input="image"><i class="bi bi-image"></i><span>Image</span></label><label class="tool-button tool-tall file-ribbon-tool"><input type="file" accept="video/*" data-media-input="video"><i class="bi bi-play-btn"></i><span>Video</span></label><label class="tool-button tool-tall file-ribbon-tool"><input type="file" accept="audio/*,.mp3" data-media-input="audio"><i class="bi bi-volume-up"></i><span>Audio</span></label><label class="checkbox-label media-cover-toggle"><input id="mediaFullBleed" type="checkbox"> Cover slide</label><button class="tool-button" type="button" data-builder-action="fit-media"><i class="bi bi-arrows-fullscreen"></i><span>Fit Slide</span></button>`),
  ...
  ribbon.innerHTML = panel("home", home, true) + panel("transitions", transitions);
